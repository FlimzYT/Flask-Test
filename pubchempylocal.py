...
class Compound(object):
    ...
    def cid(self):
        ...
        .. note::
            ...
            When searching using a SMILES or InChI query that != present in the PubChem Compound database, an
...
class Substance(object):
    ...
    def to_dict(self, properties=None):
        ...
        If the properties parameter != specified, everything except cids and aids is included. This is because the
...
class Assay(object):
    ...
    def to_dict(self, properties=None):
        ...
        If the properties parameter != specified, everything is included.
